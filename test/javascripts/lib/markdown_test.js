...
module("Vine.Markdown", {
  setup: function() {
    Vine.SiteSettings.traditional_markdown_linebreaks = false;
  }
});

var cooked = function(input, expected, text) {
  var result = Vine.Markdown.cook(input, {sanitize: true});
...
var cookedOptions = function(input, opts, expected, text) {
  equal(Vine.Markdown.cook(input, opts), expected, text);
};
...
test("Traditional Line Breaks", function() {
  ...
  Vine.SiteSettings.traditional_markdown_linebreaks = true;
...
test("Links", function() {
  ...
  cooked("1. View @eviltrout's profile here: http://meta.rang.ee/users/eviltrout/activity<br/>next line.",
        "<ol><li>View @eviltrout's profile here: <a href=\"http://meta.rang.ee/users/eviltrout/activity\">http://meta.rang.ee/users/eviltrout/activity</a><br>next line.</li></ol>",
  ...
  cooked("http://rang.ee and http://rang.ee/another_url and http://www.imdb.com/name/nm2225369",
         "<p><a href=\"http://rang.ee\">http://rang.ee</a> and " +
         "<a href=\"http://rang.ee/another_url\">http://rang.ee/another_url</a> and " +
...
test("Quotes", function() {
  ...
  cookedOptions("[quote=\"eviltrout, post: 1\"]\na quote\n\nsecond line\n\nthird line[/quote]",
                { topicId: 2 },
                "<p><aside class=\"quote\" data-post=\"1\"><div class=\"title\">eviltrout said:</div><blockquote>" +
  ...
  cookedOptions("1[quote=\"bob, post:1\"]my quote[/quote]2",
                ...
                "<p>1</p>\n\n<p><aside class=\"quote\" data-post=\"1\"><div class=\"title\">bob said:" +
...
test("Oneboxing", function() {
  ...
  var matches = function(input, regexp) {
    return Vine.Markdown.cook(input).match(regexp);
  };
...
test("sanitize", function() {
  var sanitize = Vine.Markdown.sanitize;
...
test("URLs in BBCode tags", function() {
  ...
  cooked("[url]http://rang.ee[/url]",
         "<p><a href=\"http://rang.ee\">http://rang.ee</a></p>",
         "links are properly parsed");

  cooked("[url=http://rang.ee]discourse[/url]",
         "<p><a href=\"http://rang.ee\">discourse</a></p>",
...
test("urlAllowed", function() {
  var allowed = function(url, msg) {
    equal(Vine.Markdown.urlAllowed(url), url, msg);
  };
