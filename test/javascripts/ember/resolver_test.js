...
var lookup = function(lookupString, expectedTemplate, message) {
  ...
  equal(Vine.__container__.lookup(lookupString, {singleton: false}), expectedTemplate, message);
};
...
module("Vine.Resolver", {
  setup: function() {
    originalTemplates = Ember.TEMPLATES;
    Ember.TEMPLATES = {};

    // originalMobileViewFlag = Vine.Mobile.mobileView;
    // Vine.Mobile.mobileView = false;
  },

  teardown: function() {
    Ember.TEMPLATES = originalTemplates;
    // Vine.Mobile.mobileView = originalMobileViewFlag;
  }
});
