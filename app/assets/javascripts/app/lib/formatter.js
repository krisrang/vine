Vine.Formatter = (function(){
  ...
  relativeAgeTiny = function(date, options){
    ...
    case(distanceInMinutes >= 90 && distanceInMinutes <= 1439):
      ...
      break;
    case(Vine.SiteSettings.relative_date_duration === 0 && distanceInMinutes <= 525599):
      formatted = shortDateNoYear(date);
      break;
    case(distanceInMinutes >= 1440 && distanceInMinutes <= 2519):
      formatted = t("x_days", {count: 1});
      break;
    case(distanceInMinutes >= 2520 && distanceInMinutes <= ((Vine.SiteSettings.relative_date_duration||14) * 1440)):
